...
sealed class UpdateCategoryAction {
    ...
    @Serializable
    @SerialName("create")
    data class Create(val name: String, val description: String, val items: List<ItemDto>) : UpdateCategoryAction()

    @Serializable
    @SerialName("update")
    data class Update(val id: String, val name: String, val description: String, val items: List<UpdateItemAction>) :
